...
// $base_url = 'https://po.dg24.tk';
// $base_url = 'http://192.168.88.60';
$base_url = 'https://t.dg24.tk';


// Output url..
// $turl =  "//{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}";
// $tescaped_url = htmlspecialchars( $turl, ENT_QUOTES, 'UTF-8' );
// echo '<a href="' . $tescaped_url . '">' . $tescaped_url . '</a>';
