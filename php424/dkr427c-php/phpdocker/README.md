...
------|---------|-----------
Webserver|[localhost:3102](http://localhost:3102)
Mailhog web interface|[localhost:3103](http://localhost:3103)
MySQL|**host:** `localhost`; **port:** `3104`
MariaDB|**host:** `localhost`; **port:** `3105`
